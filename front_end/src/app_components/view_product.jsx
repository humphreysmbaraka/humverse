...
import { Avatar, Box, Button, Divider, FormControl, FormLabel, HStack, Icon, Image, Input, Spinner, Tab, TabList, TabPanel, TabPanels, Tabs, Text, Textarea, VStack, Flex } from '@chakra-ui/react';
...
function View_Product() {
    ...
    return (
        <Box width="100%" minHeight="100vh" bg={'gray.800'} overflow={'auto'} css={{ '&::-webkit-scrollbar': { display: 'none', scrollbarWidth: '1px' } }} p={4}>
            {product ?
                (
                    <Flex
                    ...
                    >
                        <VStack
                            ...
                            borderRightColor={{ base: "transparent", lg: "white" }}
                            overflow={'auto'}
                        ...
                        >
                            ...
                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                DATE OF REQUEST : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.date}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                TYPE : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'} width={'100%'} isTruncated={true}>{product.type}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                TIME WINDOW : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{`${product.timequantity}  ${product.timeunit}`}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                E-Mail : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.email}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                NAMES : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.names}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                NUMBER : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.number}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                STATUS : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{!product.accepted && !product.initiated && !product.rejected && !product.cancelled ? 'NOT YET ACCEPTED' : product.accepted && !product.initiated && !product.cancelled && !product.rejected ? 'RECEIVED' : product.received && product.initiated && !product.cancelled && !product.rejected ? 'INITIATED' : product.rejected ? 'REJECTED' : product.cancelled ? 'CANCELLED' : ''}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                PREVIEWS : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{!product.previews.length}</Text>
                            </Text>

                            <Text mt={4} color={'white'} fontSize={{ base: "md", sm: "lg" }} fontWeight={'bold'} textAlign="center">PROJECT'S COSTS</Text>
                            <Divider color={'white'} height={'1px'} width={'100%'} />
                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                COST OF MAKING (paid once) : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.payments_required.making_cost}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                DEPLOYMENT (paid once): <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.payments_required.deploying_cost}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                DOMAIN NAME COST (paid yearly): <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.payments_required.domain_name_cost}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                HOSTING COST (paid monthly): <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.payments_required.domain_name_cost}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                MAINTAINANCE  (paid monthly) : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.payments_required.maintainance_cost}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                TOTAL COST : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.total_payment_required}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                ACCEPTED DEPOSIT : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.deposit_required}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                AMOUNT PAID : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.total_paid}</Text>
                            </Text>

                            <Text as={'span'} fontSize={{ base: "xs", sm: "sm" }} fontWeight={'light'} color={'white'} textAlign="center">
                                AMOUNT REMAINING : <Text as={'span'} fontSize={{ base: "sm", sm: "md" }} fontWeight={'light'} color={'white'}>{product.payments.amount_remaining}</Text>
                            </Text>
                        </VStack>
                        ...
                        <VStack
                            ...
                            alignItems={'center'}
                        >
                            <VStack width={'98%'} bg={'white'} borderRadius={'10px'} p={4} gap={4}>
                                <Flex direction={{ base: "column", md: "row" }} p={2} gap={4} width={'99%'} minHeight={'200px'} borderRadius={'10px'}>
                                    <VStack p={2} bgGradient="linear(to-r, purple.600, blue.500, cyan.400)" borderColor={'white'} borderWidth={'1px'} borderRadius={'10px'} width={{ base: "100%", md: "25%" }} height={'200px'}>
                                        <Text color={'white'} fontSize={{ base: "md", md: "lg" }} fontWeight={'bold'} alignSelf={'flex-start'} textAlign={'left'}>PROJECT INITIATION!</Text>
                                ...
                                <HStack width={'98%'} p={2} flexWrap="wrap" gap={2}>
                                ...
                                {wanttocancel &&
                                    <VStack width={'98%'} p={4} gap={4} alignItems={'center'}>
                                        <Text color={'black'} fontSize={{ base: "sm", md: "md" }} fontWeight={'bold'}>summarised tips on product cancellation</Text>
                                        <Text fontSize={{ base: "xs", sm: "sm" }} color={'black'} width={'100%'}>cancelling  24+ hrs from time of placing request will result to a deduction of 10% of the deposit </Text>
                                        <Text fontSize={{ base: "xs", sm: "sm" }} color={'black'} width={'100%'}>you will be refunded in 24 hrs </Text>
                                        <Text fontSize={{ base: "xs", sm: "sm" }} color={'black'} width={'100%'}>ask the assistant for more on the terms and conditions</Text>
                                ...
                                {wanttouncancel &&
                                    <VStack width={'98%'} p={4} gap={4} alignItems={'center'}>
                                        <Text fontSize={{ base: "xs", sm: "sm" }} color={'black'} width={'100%'}>are you sure you want to uncancel</Text>

                                        <HStack width={{ base: "100%", md: "80%" }} p={2} alignItems={'center'} justifyContent={'space-between'} flexWrap="wrap">
                                            <Button colorScheme='red' display={'flex'} alignItems={'center'} justifyContent={'center'} onClick={uncancel} size={{ base: "sm", md: "md" }}>PROCEED TO UNCANCEL</Button>
                                ...
                                {showpayform &&
                                    <>
                                        ...
                                        <Tabs variant="soft-rounded" colorScheme="teal" isFitted width="100%">
                                            <TabList mb="1em">
                                                <Tab _selected={{ color: "white", bg: "teal.500" }} fontSize={{ base: "sm", md: "md" }}>M-Pesa</Tab>
                                                <Tab _selected={{ color: "white", bg: "teal.500" }} fontSize={{ base: "sm", md: "md" }}>Visa</Tab>
                                            </TabList>
                                            ...
                                            <TabPanels>
                                                <TabPanel>
                                                    <VStack spacing={4} align="stretch">
                                                        ...
                                                        {payerror &&
                                                            <Text color={'red.500'} fontWeight={'bold'} fontSize={{ base: "xs", sm: "sm" }}>{payerror}</Text>
                                                        }
                                                        <Button colorScheme="teal" width="full" onClick={pay} gap={'10px'} size={{ base: "sm", md: "md" }}>
                                                            Pay with M-Pesa
                                                ...
                                                <TabPanel>
                                                    <VStack spacing={4} align="stretch">
                                                        ...
                                                        <FormControl>
                                                            <FormLabel fontSize={{ base: "sm", md: "md" }}>Expiry Date</FormLabel>
                                                            <Input
                                                                placeholder="MM/YY"
                                                                bg={'white'}
                                                                color="black"
                            ...
                            <Text color={'white'} fontSize={{ base: "md", md: "lg" }} fontWeight={'light'} alignSelf={'flex-start'} textAlign={'left'}>PRODUCT DESCRIPTION</Text>

                            <VStack width={'100%'} p={2} alignItems={'center'}>
                                <Textarea color={'white'} fontSize={{ base: "sm", md: "md" }} css={{ '&::-webkit-scrollbar': { display: 'none', scrollbarWidth: '1px' } }} width={'90%'} minH={'250px'} value={product.description} p={2} readOnly={true} resize={false} borderRadius={'10px'} overflow={'auto'} wordBreak={'break-word'} whiteSpace={'pre-wrap'}></Textarea>
                            </VStack>

                            <Button onClick={go_to_edit} alignSelf={'flex-end'} display={'flex'} alignItems={'center'} justifyContent={'center'} p={2} borderRadius={'10px'} colorScheme={'gray'} gap={4} size={{ base: "sm", md: "md" }}> <CiEdit size={{ base: "20px", md: "25px" }} color='white' /> EDIT REQUEST</Button>

                            <Text color={'white'} fontSize={{ base: "lg", md: "xl" }} fontWeight={'bold'} alignSelf={'flex-start'} textAlign={'left'}>YOUR ATTACHMENTS</Text>
                            <HStack width={'98%'} p={2} flexWrap={'wrap'} alignItems={'center'} justifyContent={{ base: "center", md: "flex-start" }} gap={2}>
                                {product.attachments.length > 0 &&
                                    product.attachments.map(function (val, index) {
                                        return (
                                            <VStack key={index} as='button' width={{ base: "45%", sm: "30%", md: "17%" }} borderRadius={'10px'} borderWidth={'1px'} borderColor={'white'} alignItems={'center'} p={1}>
                                                <PiFilePdf size={{ base: "80px", md: "150px" }} color='red' />
                                                <Text width={'95%'} color={'white'} isTruncated={true} fontSize={{ base: "2xs", md: "xs" }}>DOC_NAME</Text>
                                            </VStack>
                                        )
                                    })
                                }
                                ...
                                {
                                    product.attachments.length <= 0 &&
                                    <Text color={'white'} fontSize={{ base: "md", md: "lg" }}>THIS REQUEST HAD NO ATTACHMENTS</Text>
                                }
                            </HStack>

                            <Text color={'white'} fontSize={{ base: "lg", md: "xl" }} fontWeight={'bold'} alignSelf={'flex-start'} textAlign={'left'}>PROGRESS</Text>
                            <HStack width={'98%'} p={2} flexWrap={'wrap'} alignItems={'center'} justifyContent={{ base: "center", md: "flex-start" }} gap={2}>
                                <VStack minHeight={'200px'} width={{ base: "100%", sm: "45%", md: "23%" }} borderRadius={'10px'} borderWidth={'0.5px'} borderColor={'white'} alignItems={'center'} p={2}>
                                    <Text color={'white'} fontSize={{ base: "md", md: "lg" }} fontWeight={'light'} alignSelf={'flex-start'} textAlign={'left'}>FEATURES</Text>

                                    <Text mt={4} mb={2} fontSize={{ base: "2xs", md: "xs" }} fontWeight={'light'} color={'white'}>
                                        ICON   <Text as={'span'} fontSize={{ base: "2xs", md: "xs" }} fontWeight={'light'} color={'white'}>PROPERTY   <Text as={'span'} fontSize={{ base: "2xs", md: "xs" }} fontWeight={'light'} color={'white'}>DONE</Text>
                                        </Text>
                                    </Text>
                                    ...
                                    <Text mt={4} mb={2} fontSize={{ base: "2xs", md: "xs" }} fontWeight={'light'} color={'white'}>
                                        ICON   <Text as={'span'} fontSize={{ base: "2xs", md: "xs" }} fontWeight={'light'} color={'white'}>DATE   <Text as={'span'} fontSize={{ base: "2xs", md: "xs" }} fontWeight={'light'} color={'white'}>YY/MM/DD/HH/MM/SS</Text>
                                        </Text>
                                    </Text>
                                </VStack>
                            </HStack>

                            <Text color={'white'} fontSize={{ base: "lg", md: "xl" }} fontWeight={'bold'} alignSelf={'flex-start'} textAlign={'left'}>PREVIEWS</Text>
                            <Text color={'white'} fontSize={{ base: "xs", md: "sm" }} alignSelf={'flex-start'} textAlign={'left'}>DATE</Text>

                            <HStack width={'98%'} p={2} flexWrap={'wrap'} alignItems={'center'} justifyContent={{ base: "center", md: "flex-start" }} gap={4}>
                                <VStack width={{ base: "45%", sm: "30%", md: "23%" }} borderRadius={'10px'}>
                                    <Image width={'99%'} height={{ base: "120px", md: "200px" }} />
                                    <Text fontSize={{ base: "2xs", md: "xx-small" }} color={'white'} width={'90%'} isTruncated={true} textAlign={'center'}>preview name</Text>
                                </VStack>
                ...
                (
                    <Box width={'100%'} minHeight="100vh" bg={'gray.800'} display={'flex'} alignItems={'center'} justifyContent={'center'}>
                        <VStack width={{ base: "90%", md: "60%" }} borderRadius={'15px'} p={4} borderColor={'white'} borderWidth={'1px'}>
                            {fetchingproduct &&
